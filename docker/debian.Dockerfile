...
RUN set -xe && \
    ...
    apt-get install -y $(echo $(wget --no-check-certificate -qO- https://github.com/wuzongwen/nas-tools/master/package_list_debian.txt)) && \
    ...
    pip install cython && \
    pip install -r https://github.com/wuzongwen/nas-tools/master/requirements.txt && \
    # Clear
