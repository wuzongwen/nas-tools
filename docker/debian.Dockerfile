...
RUN set -xe && \
    ...
    apt-get install -y $(echo $(wget --no-check-certificate -qO- https://raw.githubusercontent.com/wuzongwen/nas-tools/master/package_list_debian.txt)) && \
    ...
    pip install cython && \
    pip install -r https://raw.githubusercontent.com/wuzongwen/nas-tools/master/requirements.txt && \
    # Clear
...
ENV S6_SERVICES_GRACETIME=30000 \
    ...
    REPO_URL="https://github.com/wuzongwen/nas-tools.git" \
