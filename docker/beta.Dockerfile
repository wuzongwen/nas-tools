...
RUN apk add --no-cache --virtual .build-deps \
        ...
        libxml2-dev \
        libxslt-dev \
    && apk add --no-cache $(echo $(wget --no-check-certificate -qO- https://github.com/wuzongwen/nas-tools/beta/package_list.txt)) \
    ...
    && pip install cython \
    && pip install -r https://github.com/wuzongwen/nas-tools/beta/requirements.txt \
